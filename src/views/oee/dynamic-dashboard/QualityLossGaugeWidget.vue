<template>
    <div class="card-body">
        <div class="chart-container">
            <div class="quality-loss-gauge" :id="'quality-loss-gauge-' + props.parentProps.id" ref="gaugeChart"></div>
        </div>
    </div>
</template>
...
const qualityLossPercent = computed(() => props.parentProps.data != null ? props.parentProps.data.toFixed(2) : 0)
    ...
    series: [
        {
            ...
            data: [{ 
                value: qualityLossPercent.value,
                itemStyle: {
...
onUpdated(() => {
    if (chartInstance) {
        chartOptions.series[0].data[0].value = qualityLossPercent.value
        chartInstance.setOption(chartOptions)
    }
})
</script>
